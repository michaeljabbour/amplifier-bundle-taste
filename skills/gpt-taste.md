---
name: gpt-taste
description: Use when generating frontend UI specifically with GPT/Codex (or another model that benefits from explicit pre-code XML planning), needing strict deterministic structure, GSAP animations, and AIDA-flow landing pages.
